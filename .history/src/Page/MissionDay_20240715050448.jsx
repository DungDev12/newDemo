...
const MissionDay = () => {
  ...
  return (
    <>
      <div className="w-full bg-[#28282D] text-white rounded-[5px] border-[#28282D] border-[2px] mb-[50px]">
        ...
        <div className="text-center py-[20px]">
          ...
          <div className="lg:w-[50%] w-[90%] mx-auto rounded-[5px] overflow-hidden border-[2px] border-[#2B2B31] overflow-x-auto">
