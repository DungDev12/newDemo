          ...
          <div className="py-[20px] min-h-[100px] overflow-x-auto">
            <table className="table lg:table-auto w-full text-center lg:text-[14px] md:text-[12px] sm:text-[11px] text-[10px]">
              <thead className="lg:text-[16px] text-[14px] ">
                <tr>
                  <th className="px-2 whitespace-nowrap">NGÂN HÀNG</th>
                  <th className="px-2 whitespace-nowrap">TÀI KHOẢN</th>
                  <th className="px-2 whitespace-nowrap">TÊN CTK</th>
                  <th className="px-2 whitespace-nowrap">CƯỢC TỐI THIỂU</th>
                  <th className="px-2 whitespace-nowrap">CƯỢC TỐI ĐA</th>
                  <th className="px-2 whitespace-nowrap">MÃ QR</th>
                </tr>
              </thead>
